...
<body>
    ...
    <main>
        ...
        <div class="links">
            ...
            <li><a href="merica.html" target="_blank" title="A site I made for a english class project">MERICA tourist site</a></li>
            <li><a href="tverfag.html" target="_blank" title="A site I made for a interdisciplinary class project">sustainability site</a></li>
        </div>   
    </main>
	<footer>
        <div id="footer">
